...
# open_project -reset subgraphiso-kria-nopreproc
open_project -reset subgraphiso-kria
# open_project subgraphiso

# add_files "source-nopreproc/subisoWrap.cpp" -cflags "-I ./source-nopreproc"
# add_files -tb "source-nopreproc/subiso-test.cpp data dataset" -cflags "-Wno-attributes -Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
